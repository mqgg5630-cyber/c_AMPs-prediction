...
# Conservative defaults for TF1.14/cuDNN7 on Ampere; raise after a smoke test.
export TF_CHUNK_SIZE="${TF_CHUNK_SIZE:-2000}" TF_PREDICT_BATCH_SIZE="${TF_PREDICT_BATCH_SIZE:-128}"
