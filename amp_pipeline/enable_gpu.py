...
def main():
    ...
    if not args.skip_test:
        ...
        # TF 1.14 + CUDA 10 on newer GPUs can fail cuBLAS with a large
        # first batch. Use a conservative batch for the verification; the
        # full pipeline can be tuned upward after the GPU path is stable.
        env["TF_PREDICT_BATCH_SIZE"] = os.environ.get("TF_PREDICT_BATCH_SIZE", "32")
        env["TF_CHUNK_SIZE"] = os.environ.get("TF_CHUNK_SIZE", "2000")
